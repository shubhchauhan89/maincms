...
// function email_send($to, $subject, $message, $user_name=null, $mail=null, $password=null, $host=null, $port=null ){   
//     date_default_timezone_set("Asia/Calcutta");


function email_send($to, $subject, $message, $user_name = null, $mail = null, $password = null, $port = null, $host = null)
{
    date_default_timezone_set("Asia/Calcutta");
    $email_config = array(
        'charset' => 'utf-8',
    ...
    $email_config["protocol"] = "smtp";
    $email_config["SMTPHost"] = $host;
    $email_config["SMTPPort"] = $port;
    $email_config["SMTPUser"] = $mail;
    //$email_config["SMTPPass"] = "H@i5,5(KQPkf";
    $email_config["SMTPPass"] = $password;
    if ($port == "587") {
        $email_config["SMTPCrypto"] = 'tls';
    } else if ($port == "465") {
        $email_config["SMTPCrypto"] = 'ssl';
    } else {
        $email_config["SMTPCrypto"] = '';
    }
...
function email_template($name, $message, $sender_name, $company_logo)
{
    ...
    return '<!DOCTYPE html>
        ...
        <head>
            ...
            <title>' . 'sfs' . '! Your Partner\'s Panel is Ready!</title>
            <style type="text/css">
            a:hover {
                ...
                >
                    ...
                    <td>
                        ...
                        <tr>
                            ...
                            <h5 style="margin-bottom: 0">Thanks & Regards,</h5>
                            ' . $sender_name . '
                            </td>
                        </tr>
                        <tr>
...
function deleteItemsFromSection($id, $item, $model)
{
    $details =  $model->select(['id', $item])->findAll();
...
{
    $url = getenv('PARENT_URL') . '/user/info';
    $post = [
...
if (!function_exists('getEmailSettings')) {
    function getEmailSettings($id = 1)
    {
        $model = new Users_model();
        $datas = $model->getEmailSettings();
        return $datas;
    }
}
