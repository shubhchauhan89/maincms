 ...
 * @return html
 */
if (!function_exists('total_dealers')) {
    ...
    function total_dealers() {
        ...
        return $template->view("widgets/totalDealers", $view_data);
    }
...
// if (!function_exists('firstBreak_widget')) {

//     function firstBreak_widget() {
//         $ci = new Security_Controller(false);
//         $view_data["clock_status"] = $ci->Attendance_model->firstbreakcurrent_clock_in_record($ci->login_user->id);
//         $template = new Template();
//         return $template->view("attendance/firstbreak", $view_data);
//     }
...
// if (!function_exists('lunchBreak_widget')) {

//     function lunchBreak_widget() {
//         $ci = new Security_Controller(false);
//         $view_data["clock_status"] = $ci->Attendance_model->lunchbreakcurrent_clock_in_record($ci->login_user->id);
//         $template = new Template();
//         return $template->view("attendance/lunchbreak", $view_data);
//     }
...
// if (!function_exists('secondBreak_widget')) {

//     function secondBreak_widget() {
//         $ci = new Security_Controller(false);
//         $view_data["clock_status"] = $ci->Attendance_model->secondbreakcurrent_clock_in_record($ci->login_user->id);
//         $template = new Template();
//         return $template->view("attendance/secondbreak", $view_data);
//     }
...
//         $view_data["total"] = $Clients_model->count_total_clients(array("show_own_clients_only_user_id" => $show_own_clients_only_user_id));
//         $template = new Template();
...
//         $Users_model = model("App\Models\Users_model");
//         $view_data["total"] = $Users_model->count_total_contacts(array("show_own_clients_only_user_id" => $show_own_clients_only_user_id));
//         $template = new Template();
...
//     function client_contacts_logged_in_widget($widget_type = "", $show_own_clients_only_user_id = "", $return_as_data = false) {
//         $ci = new Security_Controller(false);
...
//         $options = array("last_online" => $last_online, "show_own_clients_only_user_id" => $show_own_clients_only_user_id);
...
//     function client_invoices_widget($widget_type = "", $show_own_clients_only_user_id = "", $return_as_data = false) {
//         $Clients_model = model("App\Models\Clients_model");

//         $options = array("filter" => $widget_type, "show_own_clients_only_user_id" => $show_own_clients_only_user_id);
...
//     function client_projects_widget($show_own_clients_only_user_id = "", $return_as_data = false) {
//         $Clients_model = model("App\Models\Clients_model");

//         $view_data["clients_has_open_projects"] = $Clients_model->count_total_clients(array("filter" => "has_open_projects", "show_own_clients_only_user_id" => $show_own_clients_only_user_id));
//         $view_data["clients_has_completed_projects"] = $Clients_model->count_total_clients(array("filter" => "has_completed_projects", "show_own_clients_only_user_id" => $show_own_clients_only_user_id));
//         $view_data["clients_has_any_hold_projects"] = $Clients_model->count_total_clients(array("filter" => "has_any_hold_projects", "show_own_clients_only_user_id" => $show_own_clients_only_user_id));
//         $view_data["clients_has_canceled_projects"] = $Clients_model->count_total_clients(array("filter" => "has_canceled_projects", "show_own_clients_only_user_id" => $show_own_clients_only_user_id));
...
//     function client_estimates_widget($show_own_clients_only_user_id = "", $return_as_data = false) {
//         $Clients_model = model("App\Models\Clients_model");

//         $view_data["clients_has_open_estimates"] = $Clients_model->count_total_clients(array("filter" => "has_open_estimates", "show_own_clients_only_user_id" => $show_own_clients_only_user_id));
//         $view_data["clients_has_accepted_estimates"] = $Clients_model->count_total_clients(array("filter" => "has_accepted_estimates", "show_own_clients_only_user_id" => $show_own_clients_only_user_id));
//         $view_data["clients_has_new_estimate_requests"] = $Clients_model->count_total_clients(array("filter" => "has_new_estimate_requests", "show_own_clients_only_user_id" => $show_own_clients_only_user_id));
//         $view_data["clients_has_estimate_requests_in_progress"] = $Clients_model->count_total_clients(array("filter" => "has_estimate_requests_in_progress", "show_own_clients_only_user_id" => $show_own_clients_only_user_id));
...
//     function clients_has_open_tickets_widget($show_own_clients_only_user_id = "") {
//         $Clients_model = model("App\Models\Clients_model");

//         $options = array("show_own_clients_only_user_id" => $show_own_clients_only_user_id, "filter" => "has_open_tickets");

//         $view_data["clients_has_open_tickets"] = $Clients_model->count_total_clients($options);
//         $view_data["total_clients"] = $Clients_model->count_total_clients(array("show_own_clients_only_user_id" => $show_own_clients_only_user_id));
//         $template = new Template();
...
//     function clients_has_new_orders_widget($show_own_clients_only_user_id = "") {
//         $Clients_model = model("App\Models\Clients_model");

//         $options = array("filter" => "has_new_orders", "show_own_clients_only_user_id" => $show_own_clients_only_user_id);
...
//     function client_proposals_widget($show_own_clients_only_user_id = "", $return_as_data = false) {
//         $Clients_model = model("App\Models\Clients_model");

//         $view_data["clients_has_open_proposals"] = $Clients_model->count_total_clients(array("filter" => "has_open_proposals", "show_own_clients_only_user_id" => $show_own_clients_only_user_id));
//         $view_data["clients_has_accepted_proposals"] = $Clients_model->count_total_clients(array("filter" => "has_accepted_proposals", "show_own_clients_only_user_id" => $show_own_clients_only_user_id));
//         $view_data["clients_has_rejected_proposals"] = $Clients_model->count_total_clients(array("filter" => "has_rejected_proposals", "show_own_clients_only_user_id" => $show_own_clients_only_user_id));
...
// if (!function_exists('followup_notice')) {

//     function followup_notice($custom_class = "") {
//         $ci = new Security_Controller(false);

//         $my_custom_model = model("App\Models\My_custom_model");
//         $role_id = $ci->login_user->is_admin;
//         $user_id = $ci->login_user->id;
//         $view_data["followup_alter"] = $my_custom_model->getfollowupnotice($role_id,$user_id);
//         $view_data['total']=count($view_data["followup_alter"]);

//         $template = new Template();
//         return $template->view("dashboards/followup",$view_data);
//     }
