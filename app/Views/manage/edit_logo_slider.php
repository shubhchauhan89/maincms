    ...
    <div class="col-md-12 ">
        <div class="row">
            <div class="col-md-12 box-shadow border">
                <div class="mt-2 mb-2">
                    <input type="hidden" name="logo_slider_id" id="logo_slider_id" value="<?= $data->id; ?>" class="form-control">
                    <form id="UpdateLogoSlider">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <?php $img = !empty($data->image)?base_url().'/public/uploads/logo_slider_images/'.$data->image:base_url().'/public/assets/img/empty.png'; ?>
                                <img src="<?= $img;?>" class="img-fluid logo-slider-img w-50" />
                            </div>
                        </div>
