                ...
                <?php 
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="userPhone<?= $id; ?>"  class="form-control userName" value="" name="number" maxlength="10" placeholder="Mobile Number" />
                        </div>
                    </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <textarea class="form-control userName" name="message" id="userMessage<?= $id; ?>" rows="3"></textarea>
                    </div>

                    <div class="text-center mt-4">
                        <button type="button" onclick="sendMessage(<?= $id; ?>)" class="btn btn-light rounded-pill sendMessage" id="sendMessage<?= $id; ?>">
                            Send Message
                        </button>
                    </div>
                </form>
