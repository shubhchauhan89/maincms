...
<div class="about-us-page">
    ...
    <?= $this->include('theme4/frontend/layout/slider') ?>

    <!-- ----- Our Custom Section ------- -->
    <?= $this->include('theme4/frontend/layout/custom') ?>
    ...
    <!-- ----- Our Services------- -->
    <?= $this->include('theme4/frontend/layout/services') ?>
    
    <!-- ----------Our Products------ -->
    <?= $this->include('theme4/frontend/layout/products');?>

    <!-- ---------Our Updates-------- -->
    <?= $this->include('theme4/frontend/layout/posts');?>

    <!-- --------Our Videos----------- -->
    <?= $this->include('theme4/frontend/layout/videos') ?>

    <!-- --------Image Gallery---------- -->
    <?= $this->include('theme4/frontend/layout/galleries') ?>

    <!-- --------Testimonial section---------- -->
    <?= $this->include('theme4/frontend/layout/testimonials') ?>

    <!-- --------Our Faq lists----------- -->
    <!-- <?//= $this->include('theme4/frontend/layout/faq_lists') ?> -->
