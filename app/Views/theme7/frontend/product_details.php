...
<div class="product-page overflow-hidden">
    ...
    <!-- ------Slider------- -->
    <?= $this->include('theme7/frontend/layout/slider') ?>

    <!-- ----- Our Custom Section ------- -->
    <?= $this->include('theme7/frontend/layout/custom') ?>

    <!-- ----- Our Services------- -->
    <?= $this->include('theme7/frontend/layout/services') ?>
    
    <!-- ----------Our Products------ -->
    <?= $this->include('theme7/frontend/layout/products');?>

    <!-- ---------Our Updates-------- -->
    <?= $this->include('theme7/frontend/layout/posts');?>

    <!-- --------Our Videos----------- -->
    <?= $this->include('theme7/frontend/layout/videos') ?>

    <!-- --------Image Gallery---------- -->
    <?= $this->include('theme7/frontend/layout/galleries') ?>

    <!-- --------Testimonial section---------- -->
    <?= $this->include('theme7/frontend/layout/testimonials') ?>

    <!-- --------Our Faq lists----------- -->
    <!-- <?//= $this->include('theme7/frontend/layout/faq_lists') ?> -->
