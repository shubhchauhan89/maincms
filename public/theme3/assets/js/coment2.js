  ...
  var Comments = {
    ...
    preSaveAttachments: function (files, commentingField) {
      ...
      if (files.length) {
        ...
        this.options.validateAttachments(
          attachments,
    ...
    createProfilePictureElement: function (src, userId) {
      if (src) {
        ...
        var profilePicture = $("<img src=images/2.webp>", {
          class: "",
        });
      }
      profilePicture.addClass("profile-picture rounded-circle");
    ...
    createCommentingFieldElement: function (
      ...
      if (existingCommentId) {
        profilePictureURL =
          this.commentsById[existingCommentId].profilePictureURL;
    ...
    setToggleAllButtonText: function (toggleAllButton, toggle) {
      ...
      var showExpandingText = function () {
        ...
        var replyCount = toggleAllButton
          .siblings(".comment")
          .not(".hidden").length;
    ...
    linkify: function (inputText) {
      ...
      replacePattern2 =
        /(^|[^\/f])(www\.[-A-ZÄÖÅ0-9+&@#\/%?=~_|!:,.;]*[-A-ZÄÖÅ0-9+&@#\/%=~_|])/gim;
      ...
      replacePattern3 =
        /(([A-ZÄÖÅ0-9\-\_\.])+@[A-ZÄÖÅ\_]+?(\.[A-ZÄÖÅ]{2,6})+)/gim;
      replacedText = replacedText.replace(
        replacePattern3,
