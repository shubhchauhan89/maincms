      ...
      if (this.options) {
        ...
        if (this.options.values.length)
          ...
          (this.result.min_pretty = t),
            ...
            this.$cache.min.php(this.decorate(t, this.options.min)),
            this.$cache.max.php(this.decorate(i, this.options.max));
        }
