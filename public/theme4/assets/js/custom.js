    ...
    $(function () {
      ...
      $(document).on("click", '[data-toggle="card-remove"]', function (e) {
        ...
        $(document).on("click touchstart", function (e) {
          ...
          window.matchMedia("(min-width: 992px)").matches)
            ? ($(e.target).closest(".main-navbar .nav-item").length ||
              ...
              $(e.target).closest(".main-header-menu .nav-item").length ||
        ...
        $(".cover-image").each(function () {
          ...
          "undefined" !== n(e) &&
            !1 !== e &&
            $(this).css("background", "url(" + e + ") center center");
        }),
      ...
      $(".main-navbar .nav li a").each(function () {
        ...
        (o = t),
          "" === e
            ? -1 !== o.attr("href").indexOf("#") &&
              (o.parents(".main-navbar .nav-item").last().addClass("active"),
              o.parents(".main-navbar .nav-sub").length &&
                o
                  .parents(".main-navbar .nav-sub-item")
                  .last()
                  .addClass("active"))
            : -1 !== o.attr("href").indexOf(e) &&
              (o.parents(".main-navbar .nav-item").last().addClass("active"),
              o.parents(".main-navbar .nav-sub").length &&
                o
                  .parents(".main-navbar .nav-sub-item")
